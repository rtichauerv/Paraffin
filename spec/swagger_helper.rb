...
RSpec.configure do |config|
  ...
  # Define one or more Swagger documents & provide global metadata for each one
  # When you run the 'rswag:specs:swaggerize' rake task, the complete Swagger
  # will be generated at the provided relative path under swagger_root
  # By default, the operations defined in spec files are added to the first
  # document below. You can override this behavior by adding a swagger_doc tag
  # to the root example_group in your specs, e.g. describe '...', swagger_doc:
  # 'v2/swagger.json'
  config.swagger_docs = {
    'v1/swagger.json' => {
      openapi: '3.0.1',
